class Scraper 
    ...
    def get_teams
        doc.css("#main-content > article > div:nth-child(2) > div > div > div.nfl-o-ranked-item > div.nfl-o-ranked-item__content > div.nfl-o-ranked-item__title").text
    end

    def get_team_rank
        doc.search("div.nfl-o-ranked-item__label--second").text
    end
